...
import { IndicatorFlask, DoneCheck } from "../common/indicator-icons";
        ...
        <div className={"padding-hor-20 padding-vert-10 border"}>
            ...
            </div>
            {
                showRequestSections ? <div className={"margin-left-20"}>
                    ...
                    <p>These requests have NOT been delivered by IGO, which is done by marking them for delivery in IGO's Laboratory Information Management System (LIMS)</p>
            ...
            </div>
            {
                showRequestView ? <div className={"margin-left-20"}>
                    <div className={"help-unit"}>
                                ...
                                <Table aria-label="status-indicator">
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <p>One or more samples of the request are in the pending stage, e.g. three out of five projects have completed all stages, but two are pending</p>
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <p>One or more samples of the request have failed at some stage, e.g. at least one sample of the thirteen samples has failed</p>
                                            </TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                        ...
                        <p> NOTE - Even if the sample status icon shows all samples have completed all stages, this does not make the request delivered.
                            Final delivery is an IGO decision and is done by marking that request for delivery in IGO's LIMS.
                        </p>
                    </div>
                    <div className={"help-unit"}>
                        <h2 className={"inline-block"}>Section View</h2>
                        <p>
                            In each section, requests available to the logged-in user will begin populating (loading requests will have an ellipsis icon).
                            Note, if you should have visibility for a request and it does not appear in your view, please get in touch with the IGO data team.
                        </p>
                        <Row>
                            <Col xs={12} sm={6}>
                        ...
                        <p> Each request can be toggled to view a more detailed description of the request.
                            To investigate individual samples in the request, toggling the "View Samples" button will display more samples</p>
                    </div>
                    {
                        isLabMember ? <div className={"help-unit"}>
                            <h2 className={"inline-block"}>Tree View</h2>
                            <p>To IGO Lab Members, a tree view is available by clicking on the sample icon</p>
                ...
                showStageSection ? <div className={"margin-left-20"}>
                    <div className={"help-unit"}>
                        ...
                        <ul>A request is considered to have completed a stage if all of its samples have completed that stage.
                            For example, a request with four samples at stage 2 and two samples at stage 3 will report that it is pending stage 2.</ul>
                    </div>
                    <div className={"help-unit"}>
                        ...
                        <p> Every sample IGO receives enters a workflow defined in our Laboratory Information Management System (LIMS).
                            ...
                            Each one of these data records has a status that summarizes the step the physical sample was or is at.
